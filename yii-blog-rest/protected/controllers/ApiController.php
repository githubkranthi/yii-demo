...
class ApiController extends Controller
{
    ...
    public function actionList()
    {
        ...
        switch($_GET['model'])
        {
            ...
            case 'comment': // {{{
            	//	$models = new Comment();
                	$comments = new CommentController('Comment');
					$rows = $comments->getAll();
                	break; // }}}
...
/* 	        // Check if we have the USERNAME and PASSWORD HTTP headers set?
	      if(!(isset($_SERVER['X_'.self::APPLICATION_ID.'_USERNAME']) && isset($_SERVER['X_'.self::APPLICATION_ID.'_PASSWORD'])))
	        {
	                // Error: Unauthorized
 ...
 */
	        ...
	        echo "Username: " . $_SERVER['PHP_AUTH_USER'] . ", Password: " . $_SERVER['PHP_AUTH_PW'];die;
	        // Check if we have the USERNAME and PASSWORD HTTP headers set?
